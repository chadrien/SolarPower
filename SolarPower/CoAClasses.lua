...
SolarPower.CoAClasses = {
	{ token = "NECROMANCER",    index = 23, name = "Necromancer",      defaultDevotion = 4 },
	{ token = "PYROMANCER",     index = 24, name = "Pyromancer",       defaultDevotion = 4 },
	{ token = "CULTIST",        index = 25, name = "Cultist",          defaultDevotion = 4 },
	{ token = "STARCALLER",     index = 26, name = "Starcaller",       defaultDevotion = 4 },
	{ token = "SUNCLERIC",      index = 27, name = "Sun Cleric",       defaultDevotion = 4 },
	{ token = "TINKER",         index = 28, name = "Tinker",           defaultDevotion = 4 },
	{ token = "SPIRITMAGE",     index = 3,  name = "Runemaster",       defaultDevotion = 4 },
	{ token = "WILDWALKER",     index = 31, name = "Primalist",        defaultDevotion = 4 },
	{ token = "REAPER",         index = 31, name = "Reaper",           defaultDevotion = 4 },
	{ token = "PROPHET",        index = 29, name = "Venomancer",       defaultDevotion = 4 },
	{ token = "CHRONOMANCER",   index = 33, name = "Chronomancer",     defaultDevotion = 4 },
	{ token = "SONOFARUGAL",    index = 34, name = "Son of Arugal",    defaultDevotion = 4 },
	{ token = "GUARDIAN",       index = 35, name = "Guardian",         defaultDevotion = 4 },
	{ token = "STORMBRINGER",   index = 36, name = "Stormbringer",     defaultDevotion = 4 },
	{ token = "DEMONHUNTER",    index = 14, name = "Felsworn",         defaultDevotion = 4 },
	{ token = "BARBARIAN",      index = 38, name = "Barbarian",        defaultDevotion = 4 },
	{ token = "WITCHDOCTOR",    index = 39, name = "Witch Doctor",     defaultDevotion = 4 },
	{ token = "WITCHHUNTER",    index = 40, name = "Witch Hunter",     defaultDevotion = 4 },
	{ token = "FLESHWARDEN",    index = 17, name = "Knight of Xoroth", defaultDevotion = 4 },
	{ token = "MONK",           index = 19, name = "Templar",          defaultDevotion = 4 },
	{ token = "RANGER",         index = 43, name = "Ranger",           defaultDevotion = 4 },
	{ token = "PET",            index = nil, name = "Pets",            defaultDevotion = 4 },
}
